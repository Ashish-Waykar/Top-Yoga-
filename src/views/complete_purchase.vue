<template>
    <div style="background-color: red;">
      ...
      <p class="popup--subtitle">Your transaction was succesful</p>
      <p class="popup--note">You will receive an email that We Have comfirmed Your order shortly.</p>
      <a href="/" class="btn button m-button">Return to Home</a>
    </div>
    </div>
</template>
<script>
...
.page--popup .popup--note {
  font-size: 12px;
  line-height: 18px;
}
.page--popup a.btn.button {
